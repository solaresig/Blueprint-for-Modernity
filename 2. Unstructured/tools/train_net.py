"""
The script is based on https://github.com/Layout-Parser/layout-parser/blob/main/examples/Customizing%20Layout%20Models%20with%20Label%20Studio%20Annotation/Customizing%20Layout%20Models%20with%20Label%20Studio%20Annotation.ipynb. 
"""
...
def setup(args):
    ...
    cfg.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, "model_init.pth")
    #added last line to merge weights form previous model
    cfg.freeze()
